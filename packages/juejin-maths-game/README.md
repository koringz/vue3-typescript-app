...
基于某位掘友的算法，进行进一步改良和加工，仓库地址[juejin-maths-game](https://github.com/study-vue3/vue3-typescript-app)  
...
```sh
# clone 
$ git clone  https://github.com/study-vue3/vue3-typescript-app.git
